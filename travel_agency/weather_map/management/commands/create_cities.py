from travel_agency.weather_map.models import Country, City
...
countries = [
    ...
    {'timezones': ['Africa/Brazzaville'], 'code': 'CG', 'continent': 'Africa', 'name': 'Republic of the Congo',
     'capital': 'Brazzaville'},
    {'timezones': ['Africa/Abidjan'], 'code': 'CI', 'continent': 'Africa', 'name': "Cote d'Ivoire",
    ...
    {'timezones': ['Europe/Kiev', 'Europe/Uzhgorod', 'Europe/Zaporozhye', 'Europe/Simferopol'], 'code': 'UA',
     'continent': 'Europe', 'name': 'Ukraine', 'capital': 'Kyiv'},
...
class Command(BaseCommand):
    help = 'Creates initial data for cities'
